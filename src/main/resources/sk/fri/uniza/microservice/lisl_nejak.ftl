						...
						<table>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5"><a href="/data/edit/${data.id}"><i class="fas fa-pencil-alt"></i></a> <a href="javascript:void(0);" onclick="deleteData(${data.id});"><i class="fas fa-trash-alt"></i></a></td>
								</tr>
								</#items>
							</tbody>
							<#else>
